...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx6bafb985ca94cc31',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '4359e7a7ecf917c90fdb7dcf8ed666c1',
   ...
   */
  USERS: ['ovj1R53HC8OUEbKXkvRGrEQr-L_s]
    {
      // 想要发送的人的名字
      name: '丁雨菲宝宝',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'ovj1R53HC8OUEbKXkvRGrEQr-L_s',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: ' bTOYJNF5i2igULmDP4Z7RQUsQQ7Z2lYH8_mLgJdnoyk',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '成都',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '宝宝', year: '2001', date: '06-23',
        },
        {
